...
echo 'Account for company is created!';
?>
...
if(isset($_POST['submit'])){
    ...
    if(count($error) == 0) {
        $sql = "INSERT INTO user (company_name, first_name, surname, street_adress, city, dateofbirth, country_id, profile_text, study, video, profile_image) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
<div class="container mx-auto create">
    ...
    <div class="form-group">
        ...
        <input value="<?php echo (isset($_POST['company_name']) ? $_POST['company_name'] : '' );?>" type="text" name="company_name" class="form-control" id="input_companyname" placeholder="Enter the company name..">
