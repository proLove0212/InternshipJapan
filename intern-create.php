...
if(isset($_POST['submit'])){
    ...
    if(count($error) == 0) {
        $sql = "INSERT INTO user (company_name, street_adress, postal_code, city, country_id, profile_text, position, position_text, contact_name, contact_email, website) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
